#define MyAppName "Windows Service with Workers"
#define MyAppExeName "WindowsServiceWithWorkers.exe"
...
Source: "..\Output\Worker.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Output\Worker.exe.config"; DestDir: "{app}"; Flags: ignoreversion
...
;Web Content
Source: "..\Output\Web\*.*"; DestDir: "{app}\Web"; Flags: ignoreversion
Source: "..\Output\Web\css\*.*"; DestDir: "{app}\Web\css"; Flags: ignoreversion
Source: "..\Output\Web\images\*.*"; DestDir: "{app}\Web\images"; Flags: ignoreversion
Source: "..\Output\Web\scripts\*.*"; DestDir: "{app}\Web\scripts"; Flags: ignoreversion
